...
const midPolyImages = [
  ...
  "https://raw.githubusercontent.com/polaristika/sab/main/models/mid%20polly/image.webp",
];
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="p-2 inset-panel">
                <div className="relative aspect-square overflow-hidden rounded-lg border-2 border-gray-900 shadow-inner bg-black">
                  <img 
                    src="https://raw.githubusercontent.com/polaristika/sab/main/models/0001-0252-ezgif.com-optimize.gif" 
                    alt="Profile" 
